...
#ifndef MCTS_STATISTICS_MAX_UCT_STATISTIC_H_
#define MCTS_STATISTICS_MAX_UCT_STATISTIC_H_
...
class MaxUCTStatistic : public UctStatistic<MaxUCTStatistic> {
 ...
 public:
  MaxUCTStatistic(ActionIdx num_actions, MctsParameters const &mcts_parameters)
      : UctStatistic<MaxUCTStatistic>(num_actions, mcts_parameters) {
  ...
  void update_statistic(const ParentType &changed_child_statistic) {
    const MaxUCTStatistic &changed_uct_statistic =
    ...
    ucb_pair->second.action_value_ =
        std::lexicographical_compare(ucb_pair->second.action_value_.begin(),
    ...
    value_ = std::lexicographical_compare(value_.begin(), value_.end(),
                                          latest_return_.begin(),
                                          latest_return_.end())
                 ? latest_return_
                 : value_;
...
#endif  // MCTS_STATISTICS_MAX_UCT_STATISTIC_H_
